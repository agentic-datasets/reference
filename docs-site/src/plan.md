...
times, on this implementation — [`docs/FINDINGS.md`](findings.md) F-004 …
...
lexical, not semantic, and [`docs/FINDINGS.md`](findings.md) says so:
...
probabilistic quality. Both hold — see [`docs/RESULTS.md`](results.md) §3.
...
[`docs/RESULTS.md`](results.md) §2 carries the caveats.
