...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="96" height="96" role="img" aria-label="Agentic Dataset"> <title>Agentic Dataset</title> <g fill="none" stroke="currentColor" stroke-width="6" stroke-linecap="butt"> <path d="M24 11 H11 V53 H53 V11 H40"/> </g> <rect x="24" y="24" width="16" height="16" fill="currentColor"/> </svg>
